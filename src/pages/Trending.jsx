...
const MOCK_TRENDING_POSTS = [
  { id: 101, title: 'ติวเข้ม PAT1 โค้งสุดท้าย', author: 'MathGod', level: 'มัธยมศึกษาตอนปลาย', subject: 'คณิตศาสตร์', likes: 1250, views: '8.4k', image: 'https://images.unsplash.com/photo-1596495578065-6e0763fa1178?w=500&q=80' },
  { id: 102, title: 'ชีววิทยา ร่างกายมนุษย์', author: 'DrBio', level: 'มัธยมศึกษาตอนต้น', subject: 'ชีววิทยา', likes: 980, views: '12k', image: 'https://images.unsplash.com/photo-1576086213369-97a306d36557?w=500&q=80' },
  { id: 103, title: 'สรุป Tense ภาษาอังกฤษแบบเข้าใจง่าย', author: 'EngTeacher', level: 'มัธยมศึกษาตอนต้น', subject: 'ภาษาอังกฤษ', likes: 2100, views: '15k', image: 'https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?w=500&q=80' },
  { id: 104, title: 'พื้นฐานการเขียนโปรแกรม Python', author: 'CodeMaster', level: 'มหาวิทยาลัย', subject: 'วิทยาศาสตร์', likes: 850, views: '3.2k', image: 'https://images.unsplash.com/photo-1515879218367-8466d910aaa4?w=500&q=80' },
  { id: 105, title: 'เคมีอินทรีย์ ปฏิกิริยาสำคัญ', author: 'ChemLab', level: 'มัธยมศึกษาตอนปลาย', subject: 'เคมี', likes: 720, views: '4.5k', image: 'https://images.unsplash.com/photo-1603126852811-376a6d6387fb?w=500&q=80' },
];
...
export default function Trending() {
  ...
  const sortedPosts = [...MOCK_TRENDING_POSTS].sort((a, b) => {
