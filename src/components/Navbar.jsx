...
import { BookOpen, Search, Bell, User, Heart, MessageSquare, Info } from 'lucide-react';
...
export default function Navbar() {
  ...
  // Click outside to close notifications popup
  useEffect(() => {
      ...
      >
        <div className={`w-full flex justify-between items-center transition-all duration-500 ${isScrolled ? 'h-12' : 'h-14'}`}>
          ...
          <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
            ...
            <Link to="/profile" className="flex items-center justify-center p-2.5 text-slate-500 hover:text-primary bg-slate-100 hover:bg-slate-200 rounded-full transition-colors shadow-sm" title="โปรไฟล์">
