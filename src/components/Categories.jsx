...
const MOCK_CATEGORIES = [
  { id: 1, name: 'คณิตศาสตร์', views: 4520, description: 'สูตรลับและแนวข้อสอบ' },
  { id: 2, name: 'ภาษาอังกฤษ', views: 3890, description: 'แกรมม่าและคำศัพท์' },
  { id: 3, name: 'วิทยาศาสตร์', views: 3200, description: 'สรุปวิทย์เข้าใจง่าย' },
  { id: 4, name: 'สังคมศึกษา', views: 2850, description: 'ประวัติศาสตร์และหน้าที่พลเมือง' },
  { id: 5, name: 'ภาษาไทย', views: 2100, description: 'หลักภาษาและการใช้ภาษา' },
  { id: 6, name: 'ฟิสิกส์', views: 1950, description: 'กลศาสตร์และไฟฟ้า' }
];
    ...
    <section className="py-20 bg-gradient-to-b from-white to-slate-50 border-y border-slate-100 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {MOCK_CATEGORIES.slice(0, 3).map((cat, index) => (
            <Link
              key={cat.id}
